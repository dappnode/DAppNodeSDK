 ...
 * it will be removed first. After the installation, it will be check the
 * package exists, is running and that the health check (if any) is passing.
 */
export async function packageUpdateTest({
  dnpName,
  releaseMultiHash,
  compose,
  errorLogsTimeout,
