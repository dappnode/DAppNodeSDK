...
import { createPackageDirectories, writePackageFiles } from "./fileOperations.js";
...
export async function initHandler({
    ...
    const rootCompose = buildCompose({ serviceName, dnpName, version: rootManifest.version });
...
function buildCompose({ serviceName, dnpName, version }: { serviceName: string, dnpName: string, version: string }): Compose {
    return {
        version: "3.5",
        services: {
            [serviceName]: {
