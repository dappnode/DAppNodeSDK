...
// Utils
const {readManifest, writeManifest, manifestFromCompose} = require('./utils/manifest');
...
dappnodesdk
    ...
    .description('Publish a new version of the package in an Aragon Package Manager Repository. Type: [ major | minor | patch ]')
    .option('-p, --provider [provider]', `Specify a provider (overwrittes ipfs_provider and eth_provider): "dappnode" (default), "infura", "http://localhost:8545"`)
...
const sdkDescription = 'dappnodesdk is a tool to make as simple as possible the creation of new dappnode packages. \n  It helps to initialize and publish an Aragon Package Manager Repo in the ethereum mainnet.';
