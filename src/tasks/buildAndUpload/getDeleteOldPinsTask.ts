...
export function getDeleteOldPinsTask({ variantsMap, deleteOldPins, releaseUploaderProvider }: { variantsMap: VariantsMap, deleteOldPins: boolean, releaseUploaderProvider: ReleaseUploaderProvider }): ListrTask<ListrContextBuildAndPublish> {
    return {
