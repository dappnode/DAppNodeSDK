...
import { readManifest, writeManifest, readCompose, updateComposeImageTags, writeCompose } from "../../files/index.js";
...
async function increaseFromApmVersion({
    ...
    // Check variables
    const nextVersion = await getNextVersionFromApm({ type, ethProvider, ensName: manifest.name });
