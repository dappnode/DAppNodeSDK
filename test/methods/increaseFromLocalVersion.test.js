...
describe.skip('increaseFromLocalVersion', () => {
  ...
  it('Should get the last version from APM', async () => {
    ...
    expect(nextVersion).to.equal('0.1.1', 'Should output to console the next version');
    ...
    expect(compose.services[ensName].image).to.equal('admin.dnp.dappnode.eth:0.1.1', 'compose should be edited to the next version');
